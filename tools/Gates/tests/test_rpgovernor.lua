...
-- The governor's audit line goes to verified staff, not to every connection.
-- Counted rather than ignored so a change of audience shows up here as a
-- behaviour change instead of passing silently.
local staffSends = 0
RDNet = { sendStaff = function() staffSends = staffSends + 1; return 1 end }
